...
select Guest.guest_name, Room_amenities.room_id, Reservation.start_date, Reservation.end_date
from Guest
inner join Reservation on Guest.guest_id = Reservation.guest_id
inner join Room_amenities on Reservation.room_id = Room_amenities.room_id
inner join Amenities on Room_amenities.amenities_id = Amenities.amenities_id
where Amenities.type = 'jacuzzi';
